# [Ansible role anaconda](#ansible-role-anaconda)

Install anaconda on your system.

|GitHub|Issues|Pull Requests|Version|Downloads|
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-anaconda/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-anaconda/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-anaconda.svg)](https://github.com/buluma/ansible-role-anaconda/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-anaconda.svg)](https://github.com/buluma/ansible-role-anaconda/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-anaconda.svg)](https://github.com/buluma/ansible-role-anaconda/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/anaconda)](https://galaxy.ansible.com/ui/standalone/roles/buluma/anaconda/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-anaconda/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-anaconda/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-anaconda
